...
def get_src_paths_iter(_path):
    ...
    for dname, dirs, files in os.walk(_path):
        ...
        for fname in files:
            ...
            if is_binary_string(open(fpath, 'rb').read(1024)) and fpath.endswith('.jpg'):
                # print(fpath)
...
def main(passed_path = '', args=None, conf=None):
    ...
    if passed_path:
        conf.win_title = passed_path.split('/')[-1] if '/' in passed_path else passed_path
